...
const searchableFields: (keyof ProjectSummary)[] = ['title', 'projectSummaryURL', 'status', 'locale', 'category'];

const Page = (props: { projects: ProjectSummary[] }) => {
     const router = useRouter();
     const {
          searchQuery, setSearchQuery, page, rowsPerPage,
          pagedItems, filteredItems, handlePageChange, handleRowsPerPageChange,
     } = useFilterableList(props.projects, searchableFields);
